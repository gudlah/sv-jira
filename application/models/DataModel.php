...
class DataModel extends CI_Model {
    ...
    public function getAllCards() {
        return $this->db->select('jira_cards.card_id, card_title, jira_cards.card_key, jira_cards.card_description, jira_cards.card_started, jira_cards.card_created, jira_cards.card_updated, IF(jira_cards.card_resolved="0000-00-00 00:00:00", "-", card_resolved) AS card_resolved, jira_columns.column_name, jira_sprints.sprint_name, jira_boards.board_name, jira_projects.project_name, jira_priorities.priority_name, jira_users.user_display_name AS creator_name, IFNULL(tabelAssignee.user_display_name, "Unassigned") AS assignee_name, tabelReporter.user_display_name AS reporter_name, IF(jira_cards.card_started="0000-00-00 00:00:00", "-", jira_cards.card_started) AS card_started')
    ...
    public function getAllSubtasks() {
        return $this->db->select('jira_sub_tasks.sub_task_id, jira_cards.card_title, jira_sub_tasks.sub_task_key, IF(jira_sub_tasks.sub_task_started="0000-00-00 00:00:00", "-", jira_sub_tasks.sub_task_started) AS sub_task_started, jira_sub_tasks.sub_task_title, jira_sub_tasks.sub_task_description, jira_sub_tasks.sub_task_created, jira_sub_tasks.sub_task_updated, IF(jira_sub_tasks.sub_task_resolved="0000-00-00 00:00:00", "-", jira_sub_tasks.sub_task_resolved) AS sub_task_resolved, jira_columns.column_name, jira_sprints.sprint_name, jira_boards.board_name, jira_projects.project_name, jira_priorities.priority_name, jira_users.user_display_name AS creator_name, IFNULL(tabelAssignee.user_display_name, "Unassigned") AS assignee_name, tabelReporter.user_display_name AS reporter_name, tabelStatus.column_name AS status')
